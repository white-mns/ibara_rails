# 荊街データ小屋　表示用Railsアプリ
荊街データ小屋は各種定期更新ゲームの過去結果を解析して得られるデータを扱った情報サイトです。  
...
・このソースコードをダウンロードします。  
    ...
    git clone git://github.com/white-mns/ibara_rails.git
...
あとは[解析プログラム](https://github.com/white-mns/ibara_parse)側に圧縮ファイルを用意し、解析とアップロード機能を追加してデータを入れれば新しい解析項目が公開されます。
