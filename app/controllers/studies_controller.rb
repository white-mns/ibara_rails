class StudiesController < ApplicationController
  ...
  def index
    ...
    @search	= Study.distinct.notnil().includes(:pc_name, :world, :party).groups(action_name, params).for_group_select(action_name, params).having_order(params).page(params[:page]).ransack(params[:q])
