class Make < ApplicationRecord
	...
	belongs_to :last_item, :foreign_key => [:last_result_no, :requester_e_no, :i_no, :last_generate_no], :primary_key => [:result_no, :e_no, :i_no, :generate_no], :class_name => "Item"
	belongs_to :item,      :foreign_key => [:result_no, :requester_e_no, :i_no, :source_name, :generate_no], :primary_key => [:result_no, :e_no, :i_no, :name, :generate_no], :class_name => "Item"
