class AdditionPassive < ApplicationRecord
  ...
  belongs_to :addition, :foreign_key => [:requester_e_no, :addition_id, :result_no, :generate_no], :primary_key => [:requester_e_no, :addition_id, :result_no, :generate_no], :class_name => "Addition"
